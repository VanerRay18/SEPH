...
export class RolesCRUDComponent {
  searchTerm: string = '';
  headers = ['No.', 'Nombre del rol', 'Descripcion', 'Permisos', 'Modulos','Acciones'];
  displayedColumns = ['id', 'nombre', 'descripcion', 'permisos','modulos'];
  data = [];
  ...
  navigateToDashboard() {
    this.router.navigate(['/pages/Admin/Roles']);
  }
